...
The MFS (PCA10095) is a single-board development kit for evaluation
...
The ``mfs/nrf5340/cpuapp`` build target provides support for the application
core on the nRF5340 SoC. The ``mfs/nrf5340/cpunet`` build target provides
...
.. figure:: img/mfs.jpg
     ...
     MFS (Credit: Nordic Semiconductor)

More information about the board can be found at the
`MFS website`_.
The `MFS Product Specification`_
...
MFS has two external oscillators. The frequency of
...
The ``mfs/nrf5340/cpuapp`` board configuration supports the following
hardware features:
...
The ``mfs/nrf5340/cpunet`` board configuration supports the following
hardware features:
...
See `MFS Product Specification`_
for a complete list of MFS board hardware features.
...
Applications built for the ``mfs/nrf5340/cpuapp`` board by default
...
1. Build the Non-Secure Zephyr application
   for the application core using ``-DBOARD=mfs/nrf5340/cpuapp/ns``.
...
1. Build the Secure Zephyr application for the application core
   using ``-DBOARD=mfs/nrf5340/cpuapp`` and
...
2. Build the Non-Secure Zephyr application for the application core
   using ``-DBOARD=mfs/nrf5340/cpuapp/ns``.
...
and :ref:`application_run`), using ``-DBOARD=mfs/nrf5340/cpuapp`` for
the firmware running on the nRF5340 application core, and using
``-DBOARD=mfs/nrf5340/cpunet`` for the firmware running
...
.. note::
   ...
   Flashing and debugging applications on the MFS requires
...
Replace :code:`<tty_device>` with the port where the board MFS
...
Testing the LEDs and buttons in the MFS
**********************************************
...
:zephyr_file:`boards/nordic/mfs/nrf5340_cpuapp_common.dtsi`.
...
.. _MFS Product Specification: https://docs.nordicsemi.com/bundle/ps_nrf5340/page/keyfeatures_html5.html
